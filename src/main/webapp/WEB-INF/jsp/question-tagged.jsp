...
<head>
    ...
    <link href="<%=contextPath%>/css/question-tagged.css" rel="stylesheet">
    ...
    <div class="row">
        ...
        <div class="col-md-9">
            ...
            <div class="page-header">
                <a href="<%=contextPath%>/questions/tagged/${tag.id}" class="label label-info m-label-info" style="margin-right: 4px;">${tag.name}</a>
                <h1>标签相关问答
                        ...
                        <a href="<%=contextPath%>/questions/${question.id}/detail" class="question-title">${question.titleCh}</a>
                            ...
                            <c:if test="${sessionScope.userid != null}">
                                <c:if test="${question.status == 0}">
                                    <span class="label label-primary margin-left10px">机器翻译</span>
                                </c:if>
                                <c:if test="${question.status == 1}">
                                    <span class="label label-success margin-left10px">人工校译</span>
                                </c:if>
                            </c:if>
...
<%--隐藏域--%>
<input type="hidden" value="${taggedId}" id="taggedId">
...
<script type="text/javascript">
    ...
    $('#pagination').pagination({
        ...
        onPageClick: function (pageNum, evt) {
            // some code
            location.href = "/questions/tagged/" + $('#taggedId').val() + "?pageNum=" + pageNum;
        }
    });
